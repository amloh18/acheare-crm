...
const fetchContributorStats = async (username: string) => {
  const apiUrl = `https://morigird.com/api/contributors/contributorStats/${username}`;
...
const fetchContributorImage = async (username: string) => {
  const apiUrl = `https://morigird.com/api/contributors/${username}/og.png`;
...
const runCongratulate = async () => {
  ...
  const contributorUrl = `https://morigird.com/contributors/${userName}`;
  ...
  const message =
    ...
    `![Contributions](https://morigird.com/api/contributors/${userName}/og.png)`;
