...
export function PrivacyPolicyDocument() {
  return (
    <>
      ...
      <p>
        This Privacy Policy governs your access to and use of the Service and
        explains how we collect, use, safeguard, and disclose information that
      ...
      <p>
        We collect different types of information to provide and improve the
        Service for our users. This includes:
      </p>
      ...
      <p>
        Twenty uses the collected information for various purposes in order to
        operate our business, provide the Service to you, and improve our
        offerings. These purposes include:
      </p>
      ...
      <p>
        We will not use Personal Data for any purpose that is incompatible with
        the purposes outlined above without your consent.
      </p>
      ...
      <ul>
        <li>
          <p>
            ...
            <em>
              For transparency, our primary subprocessors as of this policy’s
      ...
      <p>
        Aside from the purposes listed above, we will not transfer your Personal
        Data to any third party without your knowledge, and we do not share
        personal information with third parties for their own direct marketing
        use. If we ever need to share your data in a materially different way,
        we will update this Privacy Policy and notify you as required.
      </p>

      <h2>Cookies and Tracking Technologies</h2>

      <p>
        As mentioned, Twenty uses cookies and similar tracking technologies to
        provide, secure, and improve our Service. This section explains those
        technologies in more detail and your choices regarding them.
      </p>
      ...
      <p>
        ...
        <strong>
          We do not use cookies to collect advertising information or to track
          your behavior across different websites
        </strong>
        . In fact, we avoid using third-party advertising or social media
        cookies entirely, and we do not use Google Analytics or similar invasive
        tracking tools on our marketing site. (We may use privacy-focused
        analytics or performance tracking tools that do not identify individuals
        – for example, our content delivery network and hosting providers may
        gather aggregate usage statistics for infrastructure monitoring, but
        this data is not used for advertising or profiling purposes.)
      </p>
      ...
      <p>
        ...
        <strong>
          In the event of any data breach that affects your Personal Data, we
          will notify you and the appropriate authorities as required by law.
        </strong>
      </p>
      ...
      <p>
        ...
        fulfill the purposes for which it was collected, as outlined in this
        Privacy Policy. This means we keep your information for as long as you
        maintain an account with us or as long as needed to provide you with the
        Service. We may also retain and use your Personal Data as necessary to
        comply with our legal obligations (for example, to satisfy tax,
        accounting, or reporting requirements), to resolve disputes, and to
        enforce our agreements.
      </p>

      <p>
        For users of our CRM Service, generally your account and the data within
        it (including Customer Data you have entered) will remain active and
        retained until you or your organization delete it or request its
        deletion. You have the ability to delete certain data through the
        Service interface (for instance, removing or exporting records) and you
        may delete your entire account data by contacting us if needed. Upon
        termination of your account or upon your request, we will securely
        delete or anonymize your Personal Data and any Customer Data stored in
        your account, unless we are required to retain it longer to comply with
        legal obligations or legitimate business interests (such as maintaining
        security logs or proof of consent). If complete deletion is not
        immediately possible (for example, because the data is stored in
        backups), we will isolate and protect the data from any further use
        until deletion is possible.
      </p>

      <p>
        We retain Usage Data for internal analysis and security purposes. Usage
        Data is generally kept for a shorter period of time than Personal Data,
        except when such data is used to strengthen the security or improve the
        functionality of our Service, or we are legally obligated to retain it
        for longer periods.
      </p>

      <p>
        In summary, we do not keep your data in identifiable form for longer
        than necessary. When data is no longer needed, we take steps to have it
        deleted, aggregated, or anonymized.
      </p>

      <h2>Your Rights and Choices</h2>

      <p>
        Depending on your jurisdiction and applicable data protection laws, you
        have certain rights regarding your Personal Data. Twenty is committed to
        facilitating the exercise of these rights for all users.
      </p>
      ...
      <p>
        To exercise your GDPR rights, please contact us using the contact
        information provided at the end of this policy. We may ask you to verify
        your identity before fulfilling certain requests, to ensure that your
        data is protected. We will respond to your request within the timeframes
        required by law. Please note that these rights are not absolute – there
        are exceptions and limitations. For example, we might not delete data
        that we are required to keep by law, or we might decline a request if it
        adversely affects the rights and freedoms of others. If you believe our
        processing of your Personal Data violates the GDPR, you also have the
        right to lodge a complaint with your local supervisory data protection
        authority in the EU.
      </p>
      ...
      <p>
        To exercise your California privacy rights, you (or an authorized agent
        acting on your behalf) can submit a verifiable request to us using the
        contact information at the end of this policy. Please describe your
        request with sufficient detail that allows us to properly understand,
        evaluate, and respond to it. We will verify your identity (or your
        agent’s authority) as required before acting on a request, typically by
        confirming information we already have on file. We aim to respond to
        valid requests within 45 days as required by the CCPA (or notify you if
      ...
      <p>
        Twenty is based in the United States but data is currently hosted in
        Frankfurt (EU). We plan multiple hosting locations in 2026.
      </p>

      <p>
        We will take all steps reasonably necessary to ensure that your data is
        treated securely and in accordance with this Privacy Policy. Twenty
        complies with applicable legal requirements for transferring personal
        data internationally. In particular, for Personal Data originating from
        the European Economic Area (EEA), United Kingdom, or Switzerland, we
        implement appropriate safeguards for cross-border data transfers as
        required by the GDPR and corresponding laws. These safeguards may
        include entering into Standard Contractual Clauses approved by the
        European Commission, relying on an adequacy decision by the relevant
        authority (if the destination country is deemed to provide adequate
        protection), or other lawful mechanisms. No transfer of your Personal
        Data will take place to an organization or a country unless adequate
        controls are in place to protect your information, including the
        security of your data and other personal information.
      </p>

      <p>
        Your use of our Service, followed by your submission of information to
        us, represents your consent to this transfer, storage, and processing of
        your information in the United States and other jurisdictions as
        described. If you have questions about our international data transfer
      ...
      <p>
        Our Service or website may contain links to other sites that are not
        operated by Twenty (for example, a link to an article, a partner’s
        website, or an integration provider). If you click on a third-party
        link, you will be directed to that third party’s site. We strongly
        advise you to review the privacy policy of every external site or
        service that you visit, as their privacy practices may differ from ours.
      </p>

      <p>
        We have no control over and assume no responsibility for the content,
        privacy policies, or practices of any third-party websites or services.
        When you leave our site, our Privacy Policy no longer applies. If you
        provide personal information to any third-party site, your information
        is governed by their policies. We recommend you exercise caution and
        read the privacy statements of those sites before engaging with them.
      </p>
      ...
      <p>
        {'Our Service is '}
        <strong>not intended for use by children under the age of 18</strong>.
        We do not knowingly collect personally identifiable information from
        anyone under 18 years of age. If you are under 18, please do not use the
        Service or provide any Personal Data to us.
      </p>

      <p>
        In the event that we discover we have collected Personal Data from a
        child under 18 without verified parental consent, we will take immediate
        steps to delete such information from our servers or to obtain
        appropriate consent. If you are a parent or guardian and you become
        aware that your child has provided us with Personal Data, please contact
        us so that we can take the necessary actions.
      </p>

      <p>
        Note: In certain jurisdictions, such as under U.S. COPPA law, “child” is
        defined as under 13 years old. However, our policy is to avoid
        collecting data from anyone under 18 to ensure we comply with all child
        protection regulations and because our services are business-oriented.
        We encourage parents and legal guardians to monitor their children’s
        internet usage and to help enforce this Privacy Policy by instructing
        their children never to provide Personal Data through our Service
        without permission.
      </p>
      ...
      <p>
        ...
        <strong>prior to the change becoming effective</strong>. We encourage
      ...
      <p>
        ...
        Policy become effective constitutes acceptance of those changes, to the
        extent permitted by law. If you do not agree with any updates or
        amendments, you should stop using our Service and, if you wish, delete
        your account or exercise your rights as described above.
      </p>
      ...
      <p>
        ...
        like to exercise any of your privacy rights, please contact us:
      </p>
      ...
      <p>
        You may also write to us at our business address if one is provided on
        our website. Email is the quickest way to reach us for privacy concerns.
        We take all inquiries about privacy seriously and will respond as
        promptly as possible.
      </p>

      <p>
        Thank you for trusting Twenty with your data. Your privacy is important
        to us, and we are committed to safeguarding it in accordance with this
