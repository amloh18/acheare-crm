...
export const STANDARD_COMMAND_MENU_ITEMS = {
  ...
  clockIn: {
    universalIdentifier: 'c4d5e6f7-a8b9-0123-4567-89abcdef0123',
    label: i18nLabel(
      msg({ message: `Clock In`, context: 'commandMenuItem.label' }),
    ),
    icon: 'IconClock',
    isPinned: true,
    position: 73,
    shortLabel: i18nLabel(
      msg({ message: `Clock In`, context: 'commandMenuItem.shortLabel' }),
    ),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
    engineComponentKey: EngineComponentKey.CLOCK_IN,
    hotKeys: null,
    payload: { path: '/records/attendanceDay' },
  },
  requestLeave: {
    universalIdentifier: 'd5e6f7a8-b901-2345-6789-abcdef012345',
    label: i18nLabel(
      msg({ message: `Request Leave`, context: 'commandMenuItem.label' }),
    ),
    icon: 'IconVacation',
    isPinned: true,
    position: 74,
    shortLabel: i18nLabel(
      msg({ message: `Request Leave`, context: 'commandMenuItem.shortLabel' }),
    ),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
    engineComponentKey: EngineComponentKey.REQUEST_LEAVE,
    hotKeys: null,
    payload: { path: '/records/leaveRequest' },
  },
  viewMyPayslips: {
    universalIdentifier: 'e6f7a8b9-0123-4567-89ab-cdef01234567',
    label: i18nLabel(
      msg({ message: `View My Payslips`, context: 'commandMenuItem.label' }),
    ),
    icon: 'IconReceipt',
    isPinned: false,
    position: 75,
    shortLabel: i18nLabel(
      msg({ message: `My Payslips`, context: 'commandMenuItem.shortLabel' }),
    ),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
    engineComponentKey: EngineComponentKey.VIEW_MY_PAYSLIPS,
    hotKeys: null,
    payload: { path: '/records/payslip' },
  },
  runPayroll: {
    universalIdentifier: 'f7a8b901-2345-6789-abcd-ef0123456789',
    label: i18nLabel(
      msg({ message: `Run Payroll`, context: 'commandMenuItem.label' }),
    ),
    icon: 'IconCurrencyDollar',
    isPinned: false,
    position: 76,
    shortLabel: i18nLabel(
      msg({ message: `Run Payroll`, context: 'commandMenuItem.shortLabel' }),
    ),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.WORKSPACE',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
    engineComponentKey: EngineComponentKey.RUN_PAYROLL,
    hotKeys: null,
    payload: { path: '/records/payrollPeriod' },
  },
} as const;
