...
import { computeStandardCandidateSubmissionViewGroups } from 'src/engine/workspace-manager/twenty-standard-application/utils/view-group/compute-standard-candidate-submission-view-groups.util';
...
import { computeStandardRequirementViewGroups } from 'src/engine/workspace-manager/twenty-standard-application/utils/view-group/compute-standard-requirement-view-groups.util';
...
const STANDARD_FLAT_VIEW_GROUP_METADATA_BUILDERS_BY_OBJECT_NAME = {
  candidateSubmission: computeStandardCandidateSubmissionViewGroups,
  opportunity: computeStandardOpportunityViewGroups,
  requirement: computeStandardRequirementViewGroups,
