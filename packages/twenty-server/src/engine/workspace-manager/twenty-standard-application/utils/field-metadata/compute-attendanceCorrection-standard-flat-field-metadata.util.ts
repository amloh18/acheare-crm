...
export const buildAttendanceCorrectionStandardFlatFieldMetadatas = ({
  now,
  objectName,
  workspaceId,
  ...
  CreateStandardFieldArgs<'attendanceCorrection', FieldMetadataType>,
  'context'
>): Record<string, FlatFieldMetadata> => ({
  ...
  requestedCheckIn: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'requestedCheckIn',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(
              msg({ message: `Requested Check In`, context: 'fieldMetadata.label' }),
            ),
      description: i18nLabel(
              msg({
                message: `Requested Check In`,
                context: 'fieldMetadata.description',
              }),
            ),
      icon: 'IconCalendarClock',
  ...
  requestedCheckOut: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'requestedCheckOut',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(
              msg({ message: `Requested Check Out`, context: 'fieldMetadata.label' }),
            ),
      description: i18nLabel(
              msg({
  ...
  status: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
              ...
              {
                      "id": "d1b9c7e0-5a2f-4c9d-8000-01b9c7e05a2f",
                      "position": 1,
                      "value": "APPROVED",
                      "label": "Approved",
                      "color": "green"
              ...
              {
                      "id": "d1b9c7e0-5a2f-4c9d-8000-02b9c7e05a2f",
                      "position": 2,
                      "value": "REJECTED",
                      "label": "Rejected",
                      "color": "red"
  ...
  correctedEvents: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'correctedEvents',
      isSystemSideEffect: true,
      label: i18nLabel(
        msg({ message: `Corrected Events`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Events created by this correction`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconHistory',
