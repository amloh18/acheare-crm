...
export const buildLeaveBalanceStandardFlatFieldMetadatas = ({
  now,
  objectName,
  workspaceId,
  ...
  CreateStandardFieldArgs<'leaveBalance', FieldMetadataType>,
  'context'
>): Record<string, FlatFieldMetadata> => ({
  ...
  year: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'year',
      ...
      label: i18nLabel(
              msg({ message: `Year`, context: 'fieldMetadata.label' }),
            ),
      description: i18nLabel(
              msg({
                message: `Year`,
  ...
  entitled: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'entitled',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(
              msg({ message: `Entitled`, context: 'fieldMetadata.label' }),
            ),
      description: i18nLabel(
              msg({
                message: `Entitled`,
  ...
  used: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'used',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(
              msg({ message: `Used`, context: 'fieldMetadata.label' }),
            ),
      description: i18nLabel(
              msg({
                message: `Used`,
  ...
  pending: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'pending',
