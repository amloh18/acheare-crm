...
>): Record<AllStandardObjectFieldName<'noteTarget'>, FlatFieldMetadata> => ({
  ...
  targetRequirement: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetRequirement',
      label: i18nLabel(
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetRequirementId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetCandidate: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetCandidate',
      label: i18nLabel(
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetCandidateId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetSubmission: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetSubmission',
      label: i18nLabel(
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetSubmissionId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetInterview: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetInterview',
      label: i18nLabel(
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetInterviewId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetTeam: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetTeam',
      label: i18nLabel(
  ...
  targetLocation: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
  ...
  targetEmployee: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetEmployee',
      isSystemSideEffect: true,
      label: i18nLabel(
  ...
  targetInvoice: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.MORPH_RELATION,
      morphId: STANDARD_OBJECTS.noteTarget.morphIds.targetMorphId.morphId,
      fieldName: 'targetInvoice',
      isSystemSideEffect: true,
      label: i18nLabel(
