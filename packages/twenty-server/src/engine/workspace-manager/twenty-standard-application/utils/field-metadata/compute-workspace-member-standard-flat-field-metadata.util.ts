...
> => ({
  ...
  onboardingItems: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      isSystemSideEffect: true,
      label: i18nLabel(
        msg({ message: `Onboarding Items`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Onboarding items assigned to this member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconListCheck',
  ...
  attendanceCorrections: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      isSystemSideEffect: true,
      label: i18nLabel(
        msg({ message: `Reviewed Corrections`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Attendance corrections reviewed by this member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconFileImport',
  ...
  leaveRequests: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      isSystemSideEffect: true,
      label: i18nLabel(
        msg({ message: `Reviewed Leave Requests`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Leave requests reviewed by this member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconVacation',
  ...
  departments: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      isSystemSideEffect: true,
      label: i18nLabel(
        msg({ message: `Headed Departments`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Departments headed by this member`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconBuilding',
      ...
      targetFieldName: 'departmentHead',
      settings: {
        relationType: RelationType.ONE_TO_MANY,
      },
    },
