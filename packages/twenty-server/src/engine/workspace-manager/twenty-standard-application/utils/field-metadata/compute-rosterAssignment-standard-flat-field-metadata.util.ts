...
export const buildRosterAssignmentStandardFlatFieldMetadatas = ({
  now,
  objectName,
  workspaceId,
  ...
  CreateStandardFieldArgs<'rosterAssignment', FieldMetadataType>,
  'context'
>): Record<string, FlatFieldMetadata> => ({
  ...
  employee: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      targetFieldName: 'rosterAssignments',
      settings: {
