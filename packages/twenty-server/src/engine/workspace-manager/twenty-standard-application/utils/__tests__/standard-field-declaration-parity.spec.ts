...
> = {
  ...
  onboardingItem: ['assignedTo', ...SYSTEM_RELATION_FIELD_NAMES],
  shift: [...SYSTEM_RELATION_FIELD_NAMES],
  rosterAssignment: [...SYSTEM_RELATION_FIELD_NAMES],
  attendanceEvent: [...SYSTEM_RELATION_FIELD_NAMES],
  attendanceDay: ['shift', ...SYSTEM_RELATION_FIELD_NAMES],
  attendanceCorrection: ['reviewedBy', ...SYSTEM_RELATION_FIELD_NAMES],
  leaveType: [...SYSTEM_RELATION_FIELD_NAMES],
  leaveRequest: ['reviewedBy', ...SYSTEM_RELATION_FIELD_NAMES],
