...
import { AddCardViewTypeFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-40/2-40-instance-command-fast-1788795000000-add-card-view-type';
...
export const INSTANCE_COMMANDS = [
  ...
  AddCardViewTypeFastInstanceCommand,
];
