...
@RegisteredInstanceCommand('2.40.0', 1788795000000)
export class AddCardViewTypeFastInstanceCommand implements FastInstanceCommand {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "core"."view_type_enum" ADD VALUE IF NOT EXISTS 'CARD' AFTER 'LIST'`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `UPDATE "core"."view" SET "type" = 'TABLE' WHERE "type" = 'CARD'`,
    );
    await queryRunner.query(
